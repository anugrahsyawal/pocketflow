...
| R-002 | PWA manifest references missing 192px and 512px icons. | Open | Installability/warnings | Phase 6E quality scope; generate/approve local assets and verify installation. |
...
| R-011 | Documentation normalization is uncommitted. | Current entry gate | Phase 6E could start from contradictory authority | Review, make one targeted docs commit, push, and confirm clean worktree. |
