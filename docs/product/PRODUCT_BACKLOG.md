...
| 4.4 | Edit transaction | Must Have | Done | Implemented / Legacy Evidence Incomplete / Accepted | Expense, Income, and Transfer can be edited; transaction-derived balance automatically reverses the prior effect and applies the new effect. Commit `d6bba74`. |
