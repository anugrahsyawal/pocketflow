...
export const DEFAULT_POCKETS: TemplatePocket[] = [
  ...
  { id: 'cash', name: 'Cash', emoji: '\ud83d\udcb5', groupId: 'daily', monthlyAllocation: null, initialBalance: 0, isSpendable: true, isArchived: false, budgetOwnerPocketId: 'food-groceries' },
  ...
  { id: 'nfc-card', name: 'NFC Transportation Card', emoji: '\ud83d\udcb3', groupId: 'daily', monthlyAllocation: null, initialBalance: 0, isSpendable: true, isArchived: false, budgetOwnerPocketId: 'transportation' },
